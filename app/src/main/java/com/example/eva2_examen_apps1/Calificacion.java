...
public class Calificacion extends AppCompatActivity implements ImageView.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        imgVwRes.setBackgroundResource(intent.getIntExtra("IMG",R.drawable.estrella_a));
        ...
        imgVwEs1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imgVwEs1.setBackgroundResource(R.drawable.estrella_a);
                imgVwEs2.setBackgroundResource(R.drawable.estrella_n);
                imgVwEs3.setBackgroundResource(R.drawable.estrella_n);
                estrella = 1;
            }
        });
        imgVwEs2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imgVwEs1.setBackgroundResource(R.drawable.estrella_a);
                imgVwEs2.setBackgroundResource(R.drawable.estrella_a);
                imgVwEs3.setBackgroundResource(R.drawable.estrella_n);
                estrella = 2;
            }
        });
        imgVwEs3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imgVwEs1.setBackgroundResource(R.drawable.estrella_a);
                imgVwEs2.setBackgroundResource(R.drawable.estrella_a);
                imgVwEs3.setBackgroundResource(R.drawable.estrella_a);
                estrella = 3;
            }
        });
